...
<body bgcolor="#FFFFFF"><center>
     ...
     <a href="index.php"><img class= "top-right1"src="home.png" width="50px" height="50px"></a>
...
<body>
    ...
    <form name="repRegistration" method="post" action="addstpro.php">
        ...
        <h3>Register here..</h3>
            <div class="field-column">
                ...
                <div>
                    <input type="text" class="demo-input-box"
                        name="qua"
                        value="<?php if(isset($_POST['qua'])) echo $_POST['qua']; ?>" required>
                </div>
            </div>
            ...
            <div class="field-column">
                ...
                <div>
                    <input type="text" class="demo-input-box"
                        name="college"
                        value="<?php if(isset($_POST['college'])) echo $_POST['college']; ?>" required>
                </div>
            </div>
            ...
            <div class="field-column">
                ...
                <div><input type="password" class="demo-input-box"
                    name="pwd" value="<?php if(isset($_POST['pwd'])) echo $_POST['pwd']; ?>" required></div>
            </div>
